        ...
        {loading ? (
          ...
          <>
              ...
              {projects.slice(0, 4).map((project) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-3 leading-relaxed group-hover:text-gray-700 transition-colors duration-300 line-clamp-3">{project.description}</p>
            ...
            >
              <motion.a
                href="/all-projects"
                className="inline-block bg-[#7A4F2D] text-[#F5EFE7] px-8 py-3 rounded-full font-semibold hover:bg-[#5e3b24] transition-all duration-300 shadow-lg hover:shadow-xl"
                whileHover={{
                  scale: 1.05,
